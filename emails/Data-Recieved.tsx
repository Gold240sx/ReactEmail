	...
	<Tailwind
		...
		<Html>
			...
			<Body style={main} className="bg-[#f6f9fc]">
				<Container className="bg-white my-0 mx-auto pt-5 pb-12 mb-16">
					<Section className="py-0 px-12">
						<div className="flex flex-row justify-center align-middle">
							<div className="w-fit">
								<Img src={`${baseUrl}/static/assets/mac.png`} width="55" height="55" alt="icon" />
							</div>
							<div className="w-4/5 flex justify-center align-middle">
						...
						<div className="flex flex-col border-2 border-zinc-400 px-3 w-auto h-fit">
							<Text className="">Contact Form Type:</Text>
							<table className="table-auto border-1 border-gray-200 rounded-xl">
								...
								<tbody className="text-center text-zinc-400">
									<tr>
										<td className="border px-4 py-2 font-semibold text-zinc-500">Reason</td>
